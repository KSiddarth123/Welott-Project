...
@Component({
  selector: 'app-military-u-s-gov-t',
  templateUrl: './military-u-s-gov-t.component.html',
  styleUrls: ['./military-u-s-gov-t.component.css']
})
export class MilitaryUSGovTComponent implements OnInit, AfterViewInit {
  album: IAlbum[] = [];
  ...
  ngOnInit() {
    this.loadImages('military-u-s-gov');  // Load images for this gallery
  }
