...
@Component({
  selector: 'app-aftermarket-automotive',
  templateUrl: './aftermarket-automotive.component.html',
  styleUrls: ['./aftermarket-automotive.component.css']
})
export class AftermarketAutomotiveComponent implements OnInit, AfterViewInit {
  album: IAlbum[] = [];
  ...
  ngOnInit() {
    this.loadImages('aftermarket-automotive');  // Specify the gallery name here
  }
