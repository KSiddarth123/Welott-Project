...
@Component({
  selector: 'app-gas-oil-mining',
  templateUrl: './gas-oil-mining.component.html',
  styleUrls: ['./gas-oil-mining.component.css']
})
export class GasOilMiningComponent implements OnInit, AfterViewInit {
  album: IAlbum[] = [];
  ...
  ngOnInit() {
    this.loadImages('gas-oil-mining');  // Call the method to load images for gas oil mining
  }
