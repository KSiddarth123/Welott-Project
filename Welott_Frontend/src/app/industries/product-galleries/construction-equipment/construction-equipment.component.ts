...
import { IAlbum } from './models/album.interface'; // Import your IAlbum interface

@Component({
  selector: 'app-construction-equipment',
  templateUrl: './construction-equipment.component.html',
  styleUrls: ['./construction-equipment.component.css']
})
export class ConstructionEquipmentComponent implements OnInit, AfterViewInit {
  album: IAlbum[] = [];
  ...
  ngOnInit() {
    this.loadImages('construction-equipment');  // Call the method to load images for construction equipment
  }
  ngAfterViewInit() {
